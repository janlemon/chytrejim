...
import { theme, cardStyle, inputStyle, buttonStyle, buttonTextStyle } from "../../src/theme";
...
export default function RegisterScreen() {
  ...
  const onRegister = async () => {
    ...
    try {
      ...
      // Pokud je v Supabase zapnuté potvrzení emailu, přijde verifikační odkaz.
      // Po potvrzení nebo přihlášení Gate přesměruje do /(tabs)
    } catch (e: any) {
